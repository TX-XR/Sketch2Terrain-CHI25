...
### Sketch2Terrain utilizes the widely recognized pix2pix model to facilitate the image-to-image transformation between height map of sketches and height map of terrain shapes.
![Alt text](https://github.com/ETH-IKG/Sketch2Terrain/blob/main/images/Architecture.png?raw=true "The workflow.")
