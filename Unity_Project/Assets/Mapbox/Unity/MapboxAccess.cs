...
namespace Mapbox.Unity
{
    ...
    public class MapboxAccess : IFileSource
	{
        ...
        static string _accessToken = ApplicationSettings.Instance.Mapbox_accessToken;
        [Range(0, 1000)]
		...
		private void LoadAccessToken()
		{
            ...
            SetConfiguration(mapboxConfiguration, false);
		}
	...
	public class MapboxConfiguration
	{
		...
		public string AccessToken = ApplicationSettings.Instance.Mapbox_accessToken;
